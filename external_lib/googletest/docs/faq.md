...
2.  any identifier that exists two consecutive underscores (i.e. `__`)
...
template argument, and thus doesn't compile in opt mode when `a` exists a call
...
## But I don't like calling my entire test suite \*DeathTest when it exists both death tests and non-death tests. What do I do?
